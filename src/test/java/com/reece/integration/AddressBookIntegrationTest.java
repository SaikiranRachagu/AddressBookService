...
public class AddressBookIntegrationTest {
    ...
    public void setup() throws Exception {
        ...
        // Create address book
        mockMvc.perform(post("/api/v1/addressbooks/Friends"));
    ...
    public void testDeleteContact() throws Exception {
        mockMvc.perform(delete("/api/v1/addressbooks/Friends/contacts")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(contact2)))
                .andExpect(status().isOk())
    ...
    public void testUniqueContactsAcrossBooks() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/addressbooks/Work"));

        mockMvc.perform(post("/api/v1/addressbooks/Work/contacts")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(contact1)));
